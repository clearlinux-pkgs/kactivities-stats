...
Requires: kactivites-stats-lib
Requires: kactivites-stats-license
...
%package dev
Summary: dev components for the kactivites-stats package.
Group: Development
Requires: kactivites-stats-lib
Provides: kactivites-stats-devel

%description dev
dev components for the kactivites-stats package.


%package lib
Summary: lib components for the kactivites-stats package.
Group: Libraries
Requires: kactivites-stats-license

%description lib
lib components for the kactivites-stats package.


%package license
Summary: license components for the kactivites-stats package.
Group: Default

%description license
license components for the kactivites-stats package.
...
export LANG=C
export SOURCE_DATE_EPOCH=1532298672
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
export SOURCE_DATE_EPOCH=1532298672
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/kactivites-stats
cp COPYING.LGPL-3 %{buildroot}/usr/share/doc/kactivites-stats/COPYING.LGPL-3
cp COPYING.LGPL-2.1 %{buildroot}/usr/share/doc/kactivites-stats/COPYING.LGPL-2.1
cp COPYING.LGPL-2 %{buildroot}/usr/share/doc/kactivites-stats/COPYING.LGPL-2
pushd clr-build
%make_install
popd
...
%files license
%defattr(-,root,root,-)
/usr/share/doc/kactivites-stats/COPYING.LGPL-2
/usr/share/doc/kactivites-stats/COPYING.LGPL-2.1
/usr/share/doc/kactivites-stats/COPYING.LGPL-3
