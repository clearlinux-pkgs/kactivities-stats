...
Version  : 5.60.0
Release  : 20
URL      : https://download.kde.org/stable/frameworks/5.60/kactivities-stats-5.60.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.60/kactivities-stats-5.60.0.tar.xz
Source99 : https://download.kde.org/stable/frameworks/5.60/kactivities-stats-5.60.0.tar.xz.sig
...
%prep
%setup -q -n kactivities-stats-5.60.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1563061853
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5ActivitiesStats.so.5.60.0
