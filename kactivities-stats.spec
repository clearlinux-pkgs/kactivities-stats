...
Version  : 5.113.0
Release  : 72
URL      : https://download.kde.org/stable/frameworks/5.113/kactivities-stats-5.113.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.113/kactivities-stats-5.113.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.113/kactivities-stats-5.113.0.tar.xz.sig
...
%prep
%setup -q -n kactivities-stats-5.113.0
cd %{_builddir}/kactivities-stats-5.113.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702995639
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF5ActivitiesStats.so.5.113.0
/usr/lib64/libKF5ActivitiesStats.so.1
/usr/lib64/libKF5ActivitiesStats.so.5.113.0
