...
Source0  : https://download.kde.org/stable/frameworks/5.100/kactivities-stats-5.100.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.100/kactivities-stats-5.100.0.tar.xz.sig
...
%prep
%setup -q -n kactivities-stats-5.100.0
cd %{_builddir}/kactivities-stats-5.100.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668448184
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5ActivitiesStats.so.5.100.0
